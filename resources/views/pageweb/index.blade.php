	...
	<div class="wrapper">
		...
		<div class="page-wrapper">
			<div class="page-content" style="text-align: center;">
				...
				@if(auth()->check())
					<div>
						<!-- Tombol Ayo Membaca dan Bermain -->
						<a href="{{ route('pageweb.list') }}" type="button" class="btn btn-success mb-2 uniform-button">
							<i class='bx bx-book-open'></i> Let's Read
						</a>
					</div>
					<div>
						<!-- Tombol Ayo Bermain Quiz -->
						<a href="{{ route('pageweb.quiz') }}" type="button" class="btn btn-primary mb-2 uniform-button">
					...
					<div>
						<!-- Tombol Logout -->
						<a href="{{ route('logoutuser.index') }}" type="button" class="btn btn-danger mb-2 uniform-button">
				...
				@else
					<div>
						<!-- Tombol Login -->
						<a href="{{ route('loginuser.index') }}" type="button" class="btn btn-primary mb-2 uniform-button">
