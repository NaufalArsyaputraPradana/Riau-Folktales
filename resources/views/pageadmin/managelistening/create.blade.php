                    ...
                    <div class="card border-top border-0 border-4 border-primary">
                        <div class="card-body p-5">
                            <div class="card-title d-flex align-items-center">
                                ...
                                <h5 class="mb-0 text-primary">Tambah Listening</h5>
                            </div>
                            <hr>
                            <form action="{{ route('listening.store') }}" method="POST" class="row g-3"
        ...
        document.getElementById('add-soal').addEventListener('click', function() {
            ...
            <div class="soal-item border rounded p-3 mb-3" data-index="${soalIndex}">
                <div class="mb-2">
                    ...
                    <textarea name="soal[${soalIndex}][suara]" class="form-control" required></textarea>
